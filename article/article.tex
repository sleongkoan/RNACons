...
For each base pair tree consensus, the subset of secondary structures whose base pair tree are  in the consensus are kept. String edit distance consensus (on Vienna dot brackets) are then calculated. Normally this distance function would not be suitable, but since tree distance is already minimized, the final consensus is satisfying.\newline



\begin{figure}[h]
\begin{center}
\includegraphics[scale=0.4]{figs/mccons_flowchart2.jpg}
